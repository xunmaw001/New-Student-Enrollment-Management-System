		...
		<div id="app">
			...
			<div class="recommend-container">
				...
				<div class="line-container">
					<p class="line"> 商品信息推荐 </p>
				</div>
				<div class="recommend-list">
					<ul class="recommend-item">
						<li v-for="(item,index) in shangpinxinxiRecommend" v-bind:key="index" @click="jump('../shangpinxinxi/detail.jsp?id='+item.id)">
			...
			<div class="data-container layui-row">
				...
				<div class="line-container">
					<p class="line"> 报道指南展示 </p>
				</div>
				<div style="text-align: center;margin-top: 20px;">
					<button @click="jump('../baodaozhinan/list.jsp')" type="button" class="layui-btn layui-btn-primary">查看更多>></button>
				</div>
				<div class="data-list layui-col-md8 layui-col-md-offset2">
					<div @click="jump('../baodaozhinan/detail.jsp?id='+item.id)" class="data-item layui-col-md3"  v-for="(item,index) in baodaozhinanList" v-bind:key="index" v-if="item">
																														
						<img class="cover" :src="item.tupian?item.tupian.split(',')[0]:''">
						
																																																
																		
						<h3 class="title">{{item.biaotimingcheng}}</h3>
				...
				http.request('news/list', 'get', {
					...
					if (newsList.length > 2 && newsList.length <= 8) {
						...
						console.log('rightNewsList',rightNewsList,vue.rightNewsList)
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                // 获取推荐信息
				http.request(`shangpinxinxi/autoSort?limit=4`, 'get', {
					page: 1,
					limit: 4
				}, function(res) {
					vue.shangpinxinxiRecommend = res.data.list
                                                                                                                                                                                ...
                                                                                                                                                                                http.request(`baodaozhinan/list?limit=4`, 'get', {
					page: 1,
					limit: 4
				}, function(res) {
					vue.baodaozhinanList = res.data.list
				});
