		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input type="text" name="gengxinriqi" id="gengxinriqi" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.dangqianwendu" type="text" name="dangqianwendu" id="dangqianwendu" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
                        <label class="layui-form-label">是否不适</label>
                        <div class="layui-input-block">
                            <select name="shifoubushi" id="shifoubushi" lay-filter="shifoubushi">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in shifoubushi" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
                        ...
                        <div class="layui-input-block">
                            <select name="shifoujiuyi" id="shifoujiuyi" lay-filter="shifoujiuyi">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in shifoujiuyi" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.qitaqingkuang" type="text" name="qitaqingkuang" id="qitaqingkuang" autocomplete="off" class="layui-input">
						</div>
					</div>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				var jiankangmaUpload = upload.render({
					...
					type: 'datetime'
                																				...
                																				vue.shifoubushi = '是,否'.split(',')
																vue.shifoujiuyi = '是,否'.split(',')
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					                    					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                        if(!isIntNumer(data.dangqianwendu)){
                        layer.msg('当前温度应输入整数', {
							time: 2000,
							icon: 5
						});
					...
					// 提交数据
					http.requestJson('jiankangma' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
