				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="gengxinriqi" id="gengxinriqi" placeholder="更新日期" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="dangqianwendu" id="dangqianwendu" placeholder="当前温度" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">是否不适</label>
							<div class="layui-input-block">
								<select name="shifoubushi" id="shifoubushi">
							...
							<div class="layui-input-block">
								<select name="shifoujiuyi" id="shifoujiuyi">
									<option value="">请选择</option>
							...
							<div class="layui-input-block">
								<input type="text" name="qitaqingkuang" id="qitaqingkuang" placeholder="其他情况" autocomplete="off" class="layui-input">
							</div>
						</div>
