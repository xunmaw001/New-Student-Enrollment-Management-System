		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
                        ...
                        <div class="layui-input-block">
                            <select name="fenlei" id="fenlei" lay-filter="fenlei">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in fenlei" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																								...
                																								http.request(`option/shangpinfenlei/fenlei`,'get',{},(res)=>{
					vue.fenlei = res.data
				});
																// 上传图片
