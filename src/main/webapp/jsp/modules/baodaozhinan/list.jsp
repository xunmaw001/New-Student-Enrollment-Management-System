		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">报道指南管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">报道指南管理</li>
								<li class="breadcrumb-item active">报道指南列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">报道指南列表</h3>							
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
																																									<label>
												标题名称
												<input type="text" id="biaotimingchengSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
											</label>
	...
	<script>
				  		...
				  		neirongCell.innerHTML = item.neirong;
									...
									row.appendChild(faburiqiCell);
				            				var zhuyishixiangCell  = document.createElement('td');
												  ...
												  if(item.zhuyishixiang != null && item.zhuyishixiang != "" && item.zhuyishixiang.length >= 11){
				  	zhuyishixiangCell.innerHTML = item.zhuyishixiang.substring(0, 10) + "..."; 
				  }else{
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("baodaozhinan/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"baodaozhinan");
